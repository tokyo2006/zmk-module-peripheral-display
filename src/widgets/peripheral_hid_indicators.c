    ...
    const struct peripheral_status_adv_data *s)
{
    ...
    lv_obj_set_style_text_opa(labels[0], caps ? LV_OPA_COVER : LV_OPA_60, 0);
    lv_obj_set_style_text_opa(labels[1], num  ? LV_OPA_COVER : LV_OPA_60, 0);
    lv_obj_set_style_text_opa(labels[2], scrl ? LV_OPA_COVER : LV_OPA_60, 0);
}
